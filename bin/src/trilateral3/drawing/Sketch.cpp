...
void Sketch_obj::tracerLine(Float x_,Float y_){
	::haxe::Log_obj::trace(((((((((HX_("lineTo( ",47,6b,2a,8a) + this->x) + HX_(", ",74,26,00,00)) + this->y) + HX_(", ",74,26,00,00)) + x_) + HX_(", ",74,26,00,00)) + y_) + HX_(", width )",9b,2f,cd,98)),::hx::SourceInfo(HX_("trilateral3/drawing/Sketch.hx",39,8a,a7,5a),30,HX_("trilateral3.drawing.Sketch",23,f7,00,b3),HX_("tracerLine",e1,14,6f,0a)));
}
...
void Sketch_obj::quadTo(Float x1,Float y1,Float x2,Float y2){
	this->tempArr = ::Array_obj< Float >::__new(0);
	{
		...
		Float step = ::Math_obj::min((( (Float)(1) ) / (approxDistance * ((Float)0.707))),::trilateral3::math::_Algebra::Algebra_Statics__obj::quadStep);
		int l = p->length;
		l = (l + 1);
		p[(l - 1)] = ax;
		l = (l + 1);
