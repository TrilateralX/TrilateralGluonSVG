...
void PenNodule_obj::createPen(){
	...
	bool _hx_run(){
		...
		return (drawAbstract1 < ::dsHelper::flatInterleave::core::_Flat32::Flat32_Impl__obj::get_size(_e22));
	}
	HX_END_LOCAL_FUNC0(return)
	...
	int _hx_run(){
		return ::dsHelper::flatInterleave::core::_Flat32::Flat32_Impl__obj::get_size(_e25);
	}
	HX_END_LOCAL_FUNC0(return)

	HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_26, ::haxe::io::ArrayBufferViewImpl,_e26) HXARGC(1)
	int _hx_run(int id){
		return ::dsHelper::flatInterleave::core::_Flat32::Flat32_Impl__obj::set_size(_e26,id);
	}
	HX_END_LOCAL_FUNC1(return)
	...
	int _hx_run(){
		return ::dsHelper::flatInterleave::core::_Flat32::Flat32_Impl__obj::get_size(_e39);
	}
	HX_END_LOCAL_FUNC0(return)

	HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_40, ::haxe::io::ArrayBufferViewImpl,_e40) HXARGC(1)
	int _hx_run(int id){
		return ::dsHelper::flatInterleave::core::_Flat32::Flat32_Impl__obj::set_size(_e40,id);
	}
	HX_END_LOCAL_FUNC1(return)
