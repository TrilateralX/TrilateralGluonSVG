...
int Int32ArrayImpl_obj::_get(int i){
	...
	return  ::__hxcpp_memory_get_i32(this->buffer->b,p);
}
...
int Int32ArrayImpl_obj::_set(int i,int v){
	...
	int p = ((i * 4) + this->byteOffset);
	 ::__hxcpp_memory_set_i32(this->buffer->b,p,v);
	return v;
}
...
HX_DEFINE_DYNAMIC_FUNC2(Int32ArrayImpl_obj,_set,return )
 ...
 ::typedarray::ArrayBufferViewImplIterator_typedarray__Int32Array_Int32 Int32ArrayImpl_obj::iterator(){
	...
	return  ::typedarray::ArrayBufferViewImplIterator_typedarray__Int32Array_Int32_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
}
