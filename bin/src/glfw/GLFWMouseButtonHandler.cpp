...
void GLFWMouseButtonHandler_obj::nativeCallack( GLFWwindow * win,int button,int action,int mods){
	...
	if (::glfw::GLFWMouseButtonHandler_obj::listeners->exists(ptr)) {
		::glfw::GLFWMouseButtonHandler_obj::listeners->get(ptr)(button,action,mods);
	}
}
...
void GLFWMouseButtonHandler_obj::setCallback( GLFWwindow * win, ::Dynamic func){
	::Dynamic this1 = ::glfw::GLFWMouseButtonHandler_obj::listeners;
