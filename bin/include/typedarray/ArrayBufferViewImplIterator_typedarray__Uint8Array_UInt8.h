...
{
	( ( ::typedarray::ArrayBufferViewImplIterator_typedarray__Uint8Array_UInt8)(__this) )->i = 0;
	( ( ::typedarray::ArrayBufferViewImplIterator_typedarray__Uint8Array_UInt8)(__this) )->a = array;
}
